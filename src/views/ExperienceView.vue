  ...
  <div class="grid grid-cols-2">
    <div class="pl-10 text-white">
      ...
      <div class="pt-4 pr-10">
        <p>
          Developed the Digital Anatomy application using Unreal Engine and a Django web-app to
          create a learning experience for education purposes.
        </p>
      </div>
    </div>
    <div class="pr-10 text-white">
      ...
      <h1>Internship 2022</h1>
      <div class="pt-4">
        <p>
          Created the dashboard for PlingSpot using Vue and PHP allowing business owners to get
          quick insight into company data from their various locations.
        </p>
      </div>
    </div>
  </div>
