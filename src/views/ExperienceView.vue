<template>
    <div class="grid grid-cols-2 p-5">
        <div class="pl-10">
            <div class="pb-10">
                ...
                <div class="pl-2">
                    ...
                    <h1>2024 internship</h1>
                </div>
            </div>
            <div>
                <h1 class="text-2xl">Digital Workstore</h1>
                <div class="pl-2">
                    <h1>Full-Stack Developer</h1>
                    <h1>2022 internship</h1>
                </div>
        ...
        <div class="pr-10">
            ...
            <p>Developed the dashboard for PlingSpot using Vue and PHP allowing business owners to get quick insight
